...
export async function humanDelay(min = 80, max = 250): Promise<void> {
...
export async function humanScroll(page: Page, locator?: Locator, direction: 'up' | 'down' = 'down'): Promise<void> {
  if (locator) {
    await locator.first().scrollIntoViewIfNeeded();
  } else {
