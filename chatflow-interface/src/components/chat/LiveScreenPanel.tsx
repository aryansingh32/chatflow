        ...
        <div className="flex items-center gap-2 text-sm font-medium">
          ...
          {frame ? (
            ...
            <span className="ml-1 flex items-center gap-1 text-[11px]">
              {connected ? (
                <><Wifi className="h-3 w-3 text-primary" /> <span className="text-muted-foreground">connected</span></>
              ) : (
      ...
      <div className="flex-1 overflow-y-auto p-4 scroll-thin">
        ...
        <div className="mt-4 space-y-3 rounded-xl border border-border/50 bg-card/40 p-3.5 text-[11px] leading-relaxed text-muted-foreground shadow-sm">
          <div className="flex gap-2">
            <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">⚡</div>
            <p>Frames stream securely in real time during automation.</p>
          </div>
          <div className="flex gap-2">
            <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">👁️</div>
            <p>FPS auto-adjusts to ensure smooth interaction during CAPTCHA and payments.</p>
          </div>
          {!connected && (
            <div className="flex gap-2 text-warning/90">
              <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-warning/10">⚠️</div>
