...
// Wrapped in React.memo to prevent unnecessary re-renders of the entire message history
// when new messages are added, taking advantage of the immutable chat state.
