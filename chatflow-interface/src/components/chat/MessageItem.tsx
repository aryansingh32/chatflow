...
// Optimization: Using React.memo prevents unnecessary re-renders of older
// messages in the list when new messages are appended, leveraging the
// immutable state management of the chat store.
