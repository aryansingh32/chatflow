...
// Optimization: Using React.memo to prevent unnecessary re-renders of older messages
// in the chat history when new messages are appended. Reduces rendering overhead.
