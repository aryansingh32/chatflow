 ...
 * when new messages are added. This leverages the immutable nature of the chat state.
 * Expected Impact: Reduces unnecessary re-renders of older messages by ~90% when typing or receiving new messages.
 */
