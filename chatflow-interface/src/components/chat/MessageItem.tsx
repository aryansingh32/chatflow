...
// Wrapping MessageItem in React.memo reduces unnecessary re-renders of previous chat messages
// when new messages are added, taking advantage of the immutable state management in chat-store.ts.
