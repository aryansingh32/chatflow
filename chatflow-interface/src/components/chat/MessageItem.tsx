...
// ⚡ Bolt: React.memo prevents re-rendering all previous chat messages whenever the parent component state changes
// Impact: Significantly reduces React render cycle time and CPU usage for long chat histories
