...
// ⚡ Bolt: Wraps MessageItem in React.memo to prevent unnecessary re-renders of the entire chat history
// when new messages are added, significantly improving rendering performance for long conversations.
