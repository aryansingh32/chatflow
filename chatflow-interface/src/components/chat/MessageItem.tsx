...
// Wrapped MessageItem in React.memo to prevent unnecessary re-renders of the entire
// chat history when new messages are added, improving rendering performance for long chats.
