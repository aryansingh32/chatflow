...
// ⚡ Bolt: Wrap MessageItem in React.memo to prevent unnecessary re-renders of the entire message history when new messages are added or when the typing indicator toggles.
