...
// ⚡ Bolt: Wraps MessageItem in React.memo() to prevent unnecessary re-renders
// Impact: Reduces re-renders of the entire message history when typing indicators or parent state updates, significantly improving chat scrolling and rendering performance for long threads.
