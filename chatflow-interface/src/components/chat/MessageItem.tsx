...
// message history list whenever a new message is appended or status updates occur.
// Impact: Significantly reduces React rendering workload for long chat threads.
