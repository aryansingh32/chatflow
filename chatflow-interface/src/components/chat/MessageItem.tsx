...
// Memoizing MessageItem prevents expensive re-renders of the entire chat history
// when a new message is added or when typing indicators toggle, since chat state
// is managed immutably.
