...
// ⚡ Bolt: Reduces re-renders of the entire message list when new messages are appended,
// as the chat store manages state immutably and existing messages rarely change.
