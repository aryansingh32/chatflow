...
// ⚡ Bolt: Wrapped MessageItem in React.memo to prevent unnecessary re-renders of the entire message history
// when a new message is appended or when typing state changes.
