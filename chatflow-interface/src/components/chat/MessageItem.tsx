...
// ⚡ Bolt Optimization:
// Wrapped MessageItem in React.memo() to prevent O(N) unnecessary re-renders of the entire
// chat history whenever the parent state (like liveFrame or typing indicators) updates.
// Impact: Reduces CPU load and eliminates lag when receiving fast consecutive updates.
